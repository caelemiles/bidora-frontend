...
export default function SellPage() {
  ...
  return (
    <div className="px-4 pt-4 max-w-2xl mx-auto lg:max-w-3xl lg:px-10 lg:pt-10">
      {/* Toast */}
      {showToast && (
      ...
      {/* Form card */}
      <div className="rounded-2xl bg-white shadow-sm p-5 space-y-5 lg:p-8 lg:space-y-6">
        {/* Title */}
        <div>
